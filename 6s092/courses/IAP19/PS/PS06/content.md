# Readings 
[Lecture 3: Sorting](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_lec3/) on OCW — covers Selection Sort, Insertion Sort, and Merge Sort with recurrence analysis (originally, Lecture notes 3 from Fall 2018 — "Sorting")

[Recitation 3: Sorting](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_r03/) on OCW — covers sorting algorithms, recurrences, and Master Theorem (originally, Recitation notes 3 from Fall 2018 — "Sorting")
