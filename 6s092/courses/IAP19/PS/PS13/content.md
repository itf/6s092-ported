# Readings 
[Recitation 4: Hashing](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_r04/) on OCW, section on Hashing (originally, Recitation notes 7 from Fall 2018 — "Direct Access & Hashing")

[Lecture 4: Hashing](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_lec4/) on OCW, section on Hashing (originally, Lecture notes 8 from Fall 2018 — "Direct Access & Hashing")
...
- [OCW 6.006 Spring 2020 — Practice Problems](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/pages/practice-problems/): problem sessions with worked examples and solutions.
  Most relevant: [Problem Session 3](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/problem-session-3/) — hash tables and reductions from set (hashing bounds) to sequence.
- OCW 6.006 Spring 2020 — [Problem Set 3 Questions](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_ps3-questions/) | [Solutions](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_ps3-solutions/): hash tables, universal hashing, and hashing applications
