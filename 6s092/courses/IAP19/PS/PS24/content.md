# Readings 
[Recitation 13: Dijkstra's Algorithm](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_r13/) on OCW (originally, Recitation notes 14 from Fall 2018; note number changed: was 14, now 13)

[Lecture 13: Dijkstra's Algorithm](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_lec13/) on OCW (originally, Lecture notes 14 from Fall 2018; note number changed: was 14, now 13)
...
- [OCW 6.006 Spring 2020 — Practice Problems](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/pages/practice-problems/): problem sessions with worked examples and solutions.
  Most relevant: [Problem Session 7](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/pages/practice-problems/) — Dijkstra's algorithm and all-pairs shortest paths (Problem Session 7).
- OCW 6.006 Spring 2020 — [Problem Set 6 Questions](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_ps6_questions/) | [Solutions](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_ps6_solutions/): Dijkstra's algorithm, Bellman-Ford, all-pairs shortest paths, and Johnson's algorithm
