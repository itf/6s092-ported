...
[Recitation 5: Linear Sorting](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_r05/) on OCW, Section "Comparison Sorting" (comparison sorting lower bound and transition to linear-time sorting; originally title mismatch resolved: R05 opens with comparison lower bounds before covering counting/radix sort)
