# Readings 
[Recitation 12: Bellman-Ford](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_r12/) on OCW (originally, Recitation notes 13 from Fall 2018; note number changed: was 13, now 12)

[Lecture 12: Bellman-Ford](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/resources/mit6_006s20_lec12/) on OCW (originally, Lecture notes 13 from Fall 2018; note number changed: was 13, now 12)
...
- [OCW 6.006 Spring 2020 — Practice Problems](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/pages/practice-problems/): problem sessions with worked examples and solutions.
  Most relevant: [Problem Session 6](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/pages/practice-problems/) — weighted shortest paths and relaxation (Problem Session 6).
